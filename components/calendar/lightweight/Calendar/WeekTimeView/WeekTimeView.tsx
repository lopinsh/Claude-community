...
import { MIN_HOUR, MAX_HOUR } from '../Calendar.constants';
  ...
  return (
    <>
      ...
      <div data-cy="WeekTimeViewInside" className="week-time-view-inside">
        ...
        <div
          className="week-time-week"
          style={{
            gridTemplateRows: `repeat(${hoursToShow.length}, 60px)`,
          }}
        >
          <>
            <div className="week-time-week__cover" style={{ gridTemplateRows: `repeat(${hoursToShow.length}, 60px)` }}>
            ...
            {getCurrentWeek.map((dateInfo, idx) => (
              <div key={dateInfo.date} className="week-time-week__column" style={{ gridTemplateRows: `repeat(${totalMinutes}, minmax(1px, auto))` }}>
                ...
                {dateInfo.isCurrentDay && (
                  <div
                    ...
                    style={{
                      gridColumn: '1/3',
                      gridRow:
                        (getHours(new Date()) - minHour) * 60 + getMinutes(new Date()),
                    }}
                  />
                )}
              </div>
